...
Each rectangle can get random rounded corners, so not every block stays perfectly sharp.
...
- All corners are rounded with randomized radii, constrained so arcs never overlap.
